...
class DetectionRunner:
    ...
    def _save_reference_frame(self, frame, frame_idx, confirmed, id_mapping, video_name):
        """
        Save a reference frame image every 100 frames with ID overlays.
        """
        ...
        for t in confirmed:
            ...
            cv2.putText(annotated, f"ID {fid}", (cx + 6, cy - 6), cv2.FONT_HERSHEY_SIMPLEX, 0.5, color, 1)
    ...
    def _run(self, video_path):
        # Derive log filename based on video name
        ...
        with open(log_path, 'w', newline='', encoding='utf-8') as log_file:
            ...
            while cap.isOpened() and not self._stop_event.is_set():
                ...
                if first_frame and current_count > 0:
                    ...
                    def try_matching(cx, cy, y1, y2, x1, x2):
                    ...
                    for t in confirmed:
                        ...
                        if ds_id in id_mapping:
                            ...
                            assigned = try_matching(cx, cy, y1, y2, x1, x2)
                            if assigned is None:
